...
assert f.find('wonder', exact=False) == [Hit(key=0, value="Alice's Adventures in Wonderland", score=0.2)]

# you can also search for numbers
assert f.find('1234.5678') == [Hit(key=5, value=1234.5678, score=1.0)]
